...
const Banner = () => {
    ...
    return (
        <div className="">
            ...
            <form onSubmit={handleSubmit} className=" max-w-screen-xl mx-auto bg-white p-4 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4 shadow-xl rounded-lg border-b-2">
                ...
                <input type="submit" className="bg-blue-500 text-white p-2 rounded w-full md:w-auto" value="Search" />
            </form>
        </div>
    );
};
